...
export function HotspotIntelligence() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden lg:flex-row">
      ...
      <div className="overflow-y-auto border-t lg:border-t-0 lg:border-l border-border bg-surface/40 p-4 sm:p-5 backdrop-blur-xl lg:w-[320px] lg:shrink-0 max-h-[55vh] lg:max-h-none">
